...
The security policy is detailed in [SECURITY.md](https://linktr.ee/xft.reed), and specifies how you can report security vulnerabilities and which versions will receive security updates. We run a [bug bounty program on Immunefi](https://immunefi.com/bounty/Xprotocol/) to reward the responsible disclosure of vulnerabilities.

## Audits

Audits can be found at https://github.com/x-financial-technologies/audits.
